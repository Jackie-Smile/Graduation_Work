...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/jquery.min.js" v></script>
...
<%--            <button class="btn btn-light" onclick="location.href='/UpdateChina'">更新数据</button>--%>
            <button class="btn btn-light">更新数据</button>
        </div>
...
<footer class="bg-light py-5">
    <div class="container"><div class="small text-center text-muted">Copyright © 2023 - LJH</div></div>
</footer>
</body>
</html>
